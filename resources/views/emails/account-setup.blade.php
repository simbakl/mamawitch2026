...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Un compte a été créé pour vous sur le site <strong>Mama Witch</strong>.</p>

            <p>Pour activer votre accès, veuillez configurer votre mot de passe en cliquant sur le bouton ci-dessous :</p>

            <p style="text-align: center;">
                <a href="{{ url('/account/setup/' . $user->setup_token) }}" class="btn">Configurer mon compte</a>
            </p>

            <p class="note">Vous pouvez également vous connecter directement avec votre compte Google.</p>
            <p class="note">Ce lien est valable 48 heures. Passé ce délai, demandez à un administrateur de vous renvoyer une invitation.</p>
        </div>
