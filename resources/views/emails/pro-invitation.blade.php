...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Pour activer votre accès, cliquez sur le bouton ci-dessous :</p>

            <p style="text-align: center;">
                <a href="{{ url('/pro/invitation/' . $proAccount->invitation_token) }}" class="btn">Activer mon accès pro</a>
            </p>

            <p class="note">Vous pourrez vous connecter avec un mot de passe ou via votre compte Google.</p>
        </div>
