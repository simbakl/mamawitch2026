...
@php
    $articleData = [
        ...
        'author' => ['@type' => 'MusicGroup', 'name' => 'Mama Witch'],
    ];
    if ($article->featured_image) {
        $articleData['image'] = asset('storage/' . $article->featured_image);
    }
@endphp
<script type="application/ld+json">
{!! json_encode($articleData, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) !!}
</script>
@endpush
