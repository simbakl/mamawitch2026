                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex flex-wrap gap-2">
                            @if ($release->spotify_url)
                                <a href="{{ $release->spotify_url }}" target="_blank" rel="noopener noreferrer" class="px-3 py-1 bg-[#1DB954]/20 text-[#1DB954] hover:bg-[#1DB954] hover:text-black text-xs font-heading uppercase rounded transition-all">Spotify</a>
                            @endif
                            @if ($release->bandcamp_url)
                                <a href="{{ $release->bandcamp_url }}" target="_blank" rel="noopener noreferrer" class="px-3 py-1 bg-[#629aa9]/20 text-[#629aa9] hover:bg-[#629aa9] hover:text-black text-xs font-heading uppercase rounded transition-all">Bandcamp</a>
                            @endif
                            @if ($release->apple_music_url)
                                <a href="{{ $release->apple_music_url }}" target="_blank" rel="noopener noreferrer" class="px-3 py-1 bg-[#fc3c44]/20 text-[#fc3c44] hover:bg-[#fc3c44] hover:text-white text-xs font-heading uppercase rounded transition-all">Apple Music</a>
                            @endif
                            @if ($release->deezer_url)
                                <a href="{{ $release->deezer_url }}" target="_blank" rel="noopener noreferrer" class="px-3 py-1 bg-[#a238ff]/20 text-[#a238ff] hover:bg-[#a238ff] hover:text-white text-xs font-heading uppercase rounded transition-all">Deezer</a>
                            @endif
                        </div>
                    </div>
                </div>
